# Sort (поиск потока, сортировка потока,преобразование списка в поток, использование коллекции в сборщике, которая сортирует в естественном порядке - например TreeSet)
